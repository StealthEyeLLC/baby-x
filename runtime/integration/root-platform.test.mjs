...
test('root platform public operations dispatch and reconciliation survives restart', async () => {
  ...
  try {
    ...
    assert.deepEqual(listed.providers.map((entry) => entry.providerId), ['bpf-lsm', 'host-capability-probe', 'landlock', 'prompt1-root-authority', 'seccomp-filter', 'seccomp-notify', 'sovereign-platform-core']);
