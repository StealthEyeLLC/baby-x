...
**Status:** Governing design and implementation guidance. Checkpoints A through H are implemented on the authorized build branch. Final real disposable certification remains required.
...
10. [Checkpoint H isolated candidate racing](../ISOLATED-CANDIDATE-RACING.md)
